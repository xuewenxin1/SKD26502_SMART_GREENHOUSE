...
#define PORT_FORWARD GPIOC
#define PIN_FORWARD GPIO_PIN_11
#define PORT_REVERSE GPIOC
#define PIN_REVERSE GPIO_PIN_12
...
public:
    virtual bool init(){
        ...
        HAL_NVIC_SetPriority(TIM6_DAC_LPTIM1_IRQn,1,1);
