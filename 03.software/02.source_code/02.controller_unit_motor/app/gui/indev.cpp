...
#define PORT_BUTTON_MODE GPIOC
#define PIN_BUTTON_MODE GPIO_PIN_13
#define PORT_BUTTON_SETTING GPIOF
#define PIN_BUTTON_SETTING GPIO_PIN_6
#define PORT_BUTTON_PLUS GPIOB
#define PIN_BUTTON_PLUS GPIO_PIN_12
