...
#define PIN_BUTTON_MODE GPIO_PIN_7
#define PORT_BUTTON_SETTING GPIOA
#define PIN_BUTTON_SETTING GPIO_PIN_8
#define PORT_BUTTON_PLUS GPIOD
#define PIN_BUTTON_PLUS GPIO_PIN_7
#define PORT_BUTTON_MINUS GPIOC
#define PIN_BUTTON_MINUS GPIO_PIN_7
