...
#define MOTOR_TURN_SECONDS_MIN 5
...
typedef struct Config {
    ...
    int temp_compensation_value;     /* 温度传感器补偿值(P4)，×10，范围 −9.0～+9.0℃. */
    ...
    int last_motor_timer_cnt;        /* 上次行程计时(整秒×1000ms)，上电恢复已转时间/圈数. */
} Config_t;
